...
1. click on the "<> Code" dropdown thing
2. click "Download ZIP"
3. open the zip and you should get a folder called "TIS-GPA-Calculator-main"
4. type chrome://extensions in the url bar of your browser (don't use ur school acc it won't work)
